 ...
 * <p>
 * This must be the very first authpipeline, so unsigned JWTs are never analyzed in any way. This authpipeline doesn't
 * need ot create a user principal, so passing {@code null} is OK.
 */
